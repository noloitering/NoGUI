...
int main(int argc, char ** argv)
{
	...
	std::shared_ptr< NoGUI::Shape > circle = std::make_shared< NoGUI::Shape >(0, fill);
	
	NoGUI::Transform topT = NoGUI::Transform((Vector2){window.x / 2, 50}, elemSize, NoGUI::Align::TOP);
	NoGUI::Transform centerT = NoGUI::Transform((Vector2){window.x / 2, window.y / 2}, (Vector2){25, 25}, NoGUI::Align::CENTER);
	...
	while ( !WindowShouldClose() )
	{
		...
		{
			topElem->reorient(0, NoGUI::Align::TOP);
